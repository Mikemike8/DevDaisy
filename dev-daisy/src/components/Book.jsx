  ...
  return (
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        <h2 className="text-base font-semibold text-indigo-600">Booking</h2>
        <p className="mt-2 text-5xl font-semibold tracking-tight text-gray-900 sm:text-6xl">
           Book the right plan that fits  you
        </p>
      </div>
        ...
        {tiers.map((tier, tierIdx) => (
          <div
            ...
            className={classNames(
              ...
              "rounded-3xl p-8 ring-1 ring-inset ring-gray-900/10 sm:p-10"
            )}
          >
            <h3
              id={tier.id}
            ...
            <a
              ...
              className={classNames(
                tier.featured
                  ...
                  : "text-indigo-600 ring-inset ring-indigo-200 hover:ring-indigo-300 focus-visible:outline-indigo-600",
